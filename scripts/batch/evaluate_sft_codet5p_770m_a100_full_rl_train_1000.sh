#!/bin/sh
#BSUB -q gpua100
#BSUB -J eval_sft_a100_full_rl_train_1000
#BSUB -n 24
#BSUB -R "span[hosts=1]"
...
#BSUB -W 8:00
#BSUB -o data/evaluations/sft_codet5p_770m_a100_full_rl_train_1000_seed42/lsf_%J.out
#BSUB -e data/evaluations/sft_codet5p_770m_a100_full_rl_train_1000_seed42/lsf_%J.err
...
experiment_dir=data/evaluations/sft_codet5p_770m_a100_full_rl_train_1000_seed42
batch_id=sft_codet5p_770m_a100_full_rl_train_1000_seed42
...
uv run --no-sync python -m alphaproof.inference.infer \
    --config alphaproof/yaml/codet5p_770m_a100_full_sft.yaml \
    --input "$experiment_dir/requests.jsonl" \
    --batch-id "$batch_id" \
    --run-dir data/runs/sft_codet5p_770m_a100_full_01 \
    --num-simulations 64 \
